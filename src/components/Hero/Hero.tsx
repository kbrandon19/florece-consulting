    ...
    <div className="w-full h-screen bg-charcoal flex flex-col items-center content-center justify-center align-center">
      <Transition>
        ...
        <div className="align-center w-auto mt-5">
          <h1 className=" w-26 text-seaSalt text-5xl lg:text-7xl 2xl:text-9xl flex justify-center content-center font-medium lowercase drop-shadow-lg tracking-wider">
            {data.text}
          </h1>
        </div>
      </Transition>
