  ...
  return (
    <div className=" w-full h-100vh bg-sec-cambridgeBlue flex justify-center content-center">
      <div className="w-5/6 h-auto  m-auto my-28 text-left break-words font-semibold max-w-7xl flex flex-col gap-16">
        ...
        <div>
          <p className="text-4xl text-seaSalt italic">Let&apos;s get you back <Link href="/" className="hover:text-accent-appricot transition-colors hover:drop-shadow-sm">home</Link>.</p>
        </div>
      </div>
    </div>
  )
